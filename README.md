...
Corpus version 1.17.0. The corpus was regenerated from scratch at v1.0.0 on
2026-07-26, superseding the lost v0.1 entirely.

Phase 0 is complete and reviewed. The repository compiles, tests, migrates and
seeds its configuration, and holds no market data and no domain logic. Phase 1
detail is written and not built.
