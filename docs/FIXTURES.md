...
Build state: **partly built**. The twenty-six entries registered against
0.2 to 1.1 are implemented, being twenty-four fixtures and two guards; the
rest belong to checkpoints not yet reached.
